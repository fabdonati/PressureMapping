...
% Version: 0.15.3
% $Rev: 689 $
% $Date: 2012-02-09 17:55:18 +0000 (Thu, 09 Feb 2012) $
% 
...
% Gerardus optiont that requires compilation of MEX: [dp, ~] = dijkstra(dbr, 1);
% MatlabCentral option (http://uk.mathworks.com/matlabcentral/fileexchange/10922-matlabbgl)
[dp, ~] = dijkstra_sp(dbr, 1);
...
% Gerardus optiont that requires compilation of MEX: [dp, parents] = dijkstra(dbr, v0);
% MatlabCentral option (http://uk.mathworks.com/matlabcentral/fileexchange/10922-matlabbgl)
[dp, parents] = dijkstra_sp(dbr, v0);
[~, v1] = max(dp);
