function V = show_segment_surface( binary, originORM_v2w, spacing, c, alpha, isovalue )
% Surface rendering of a cloud of points
% - seg: 3D binary mask
fprintf(1,'\n        Starting show_segment_surface... \n\n');

if nargin < 2; originORM_v2w = [0 0 0]; end
